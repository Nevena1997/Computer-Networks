...
final class CopyTextMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            InputStreamReader in = new InputStreamReader(new FileInputStream("c01_Streams/i03_copy_text/in.txt"));
            OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("c01_Streams/i03_copy_text/out.txt"));
