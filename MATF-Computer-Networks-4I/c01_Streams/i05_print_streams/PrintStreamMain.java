    ...
    public static void main(String[] args) {
        ...
        try (PrintStream pw = new PrintStream(
                new BufferedOutputStream(
                        new FileOutputStream("c01_Streams/i05_print_streams/pw_out.txt")
                )
            )
        ) {
            pw.print("Hello");
        ...
        try (Scanner sc = new Scanner(new FileInputStream("c01_Streams/i05_print_streams/pw_out.txt"))) {
            if (sc.hasNextLine())
